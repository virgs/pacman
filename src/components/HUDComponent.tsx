...
import { emitFinalScore, useGhostStateChangedListener, usePacmanDiedListener } from '../events/Events'
...
export const HUDComponent = (): JSX.Element => {
    ...
    usePacmanDiedListener(() => {
        emitFinalScore({ score: scoreCounter })
    })
    ...
    useInterval(() => {
        if (transitionCount !== undefined) {
            if (transitionCount > GameConfig.powerUpEffectDurationInMs) {
                ...
                const fadeOutStartThreshold = GameConfig.powerUpEffectDurationInMs * 0.75
    ...
    return (
        <div className="row m-0 w-100 justify-content-between g-1">
            ...
            <div className={`col-3 score-info`} style={ghostStyle}>
