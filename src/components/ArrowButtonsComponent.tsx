        ...
        <>
            <div className="row justify-content-center g-2">
                <div className="col-4 align-self-end">
                    <button
                        type="button"
                        className="btn btn-outline-info arrow-button"
                        onPointerUp={() => onButtonPressed(Direction.UP)}
                    >
                    ...
                    <div className="row justify-content-center align-items-start g-2">
                        <div className="col-4">
                            <button
                                type="button"
                                className="btn btn-outline-info arrow-button"
                                onPointerUp={() => onButtonPressed(Direction.LEFT)}
                            >
                        ...
                        <div className="col-4">
                            <button
                                type="button"
                                className="btn btn-outline-info arrow-button"
                                onPointerUp={() => onButtonPressed(Direction.DOWN)}
                            >
                        ...
                        <div className="col-4">
                            <button
                                type="button"
                                className="btn btn-outline-info arrow-button"
                                onPointerUp={() => onButtonPressed(Direction.RIGHT)}
                            >
